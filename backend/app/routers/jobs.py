...
from app.services.job_service import create_job, get_all_jobs, get_job_alllogs, cancel_job,handle_job_progress,event_stream
...
@router.get("/jobs/{job_id}/logs/sse")
